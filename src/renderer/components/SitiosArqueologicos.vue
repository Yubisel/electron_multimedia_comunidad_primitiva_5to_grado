    ...
    props: ['searchText'],
        data(){
            return{
                ...
                bayamo_2: `<p class="cp5g">Ubicación de los sitios arqueológicos reportados en el municipio Bayamo</p>`,
                bartolome_maso_1: `<h2>Bartolomé Masó</h2>`,
                bartolome_maso_2: `<p class="cp5g">Ubicación de los sitios arqueológicos reportados en el municipio Bartolomé Masó</p>`,
                buey_arriba_1: `<h2>Buey Arriba</h2>`,
                buey_arriba_2: `<p class="cp5g">Ubicación de los sitios arqueológicos reportados en el municipio Buey Arriba</p>`,
                campechuela_1: `<h2>Campechuela</h2>`,
                campechuela_2: `<p class="cp5g">Ubicación de los sitios arqueológicos reportados en el municipio Campechuela</p>`,
                cauto_cristo_1: `<h2>Cauto Cristo</h2>`,
                cauto_cristo_2: `<p class="cp5g">Ubicación de los sitios arqueológicos reportados en el municipio Cauto Cristo</p>`,
                guisa_1: `<h2>Guisa</h2>`,
                guisa_2: `<p class="cp5g">Ubicación de los sitios arqueológicos reportados en el municipio Guisa</p>`,
                jiguani_1: `<h2>Jiguaní</h2>`,
                jiguani_2: `<p class="cp5g">Ubicación de los sitios arqueológicos reportados en el municipio Jiguaní</p>`,
                manzanillo_1: `<h2>Manzanillo</h2>`,
                manzanillo_2: `<p class="cp5g">Ubicación de los sitios arqueológicos reportados en el municipio Manzanillo </p>`,
                media_luna_1: `<h2>Media Luna</h2>`,
                media_luna_2: `<p class="cp5g">Ubicación de los sitios arqueológicos reportados en el municipio Media Luna</p>`,
                niquero_1: `<h2>Niquero</h2>`,
                niquero_2: `<p class="cp5g">Ubicación de los sitios arqueológicos reportados en el municipio Niquero</p>`,
                rio_cauto_1: `<h2>Río Cauto</h2>`,
                rio_cauto_2: `<p class="cp5g">Ubicación de los sitios arqueológicos reportados en el municipio Río Cauto</p>`,
                pilon_1: `<h2>Pilón</h2>`,
                pilon_2: `<p class="cp5g">Ubicación de los sitios arqueológicos reportados en el municipio Pilón</p>`,
                yara_1: `<h2>Yara</h2>`,
                yara_2: `<p class="cp5g">Ubicación de los sitios arqueológicos reportados en el municipio Yara</p>`,
            }
        }
    }
</script>
